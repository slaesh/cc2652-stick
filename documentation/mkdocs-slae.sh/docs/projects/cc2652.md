...
<button
  ...
  data-item-name="CC2652RB stick"
  data-item-custom1-name="external antenna type"
  data-item-custom1-options="Type 1[+1.5]|Type 2[+1.5]|Type 3[+1.5]|Type 4[+1.5]|No Antenna"
  data-item-custom1-required="true"
  data-item-custom1-value="Type 2"
  data-item-custom2-name="firmware"
  data-item-custom2-options="zigbee2mqtt|OpenThread|none"
  data-item-custom3-name="pin-headers"
  ...
  data-item-custom5-options="None, thanks! :)|1[+1]|2[+2]|5[+5]|10[+10]">
  Just click here to buy one!
</button>

If this button is orange, and clickable.. We have stock! And will ship within the next 1-4 days. Depending on the incoming orders.
Except during christmas. Last shipment will be done on 23.12. and then starting again on 28.12.! ;)

Or use Tindie: (back in January there)
...
Or text me on [Telegram](https://t.me/slaesh) for urgent requests and technical support!
