...
!!! info "projects realized.."
    ...
    - [MCP9808 temperature sensor](/projects/lipo_powered_solar_temp_sens)

## The Stick

### Get one

!!! info "TAKING A BREATH AND MAINTENANCE"
    - just doing small chunks of orders right now, to test our processes! :)
    - so toggling between waitlist and shop.. =)
    - thanks for waiting hope you get your stick soon!
...
<p>
   ...
   class="cta__button"
   id="join_waitinglist"
   onClick="joinWatchlist('cc2652_april', 'cc2652-stick')">
   Join waitinglist..
   </button>
</p>
-->
...
!!! tip "STOCK"
    ...
    - We are not Amazon and we do not want to become one.. So if you are in a rush, please choose another option! =))
